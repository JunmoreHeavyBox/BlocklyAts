...
Blockly.Msg["OBVE_VSTATE_CANT"]="curve cant";
Blockly.Msg["OBVE_VSTATE_PITCH"]="pitch";
Blockly.Msg["OBVE_VSTATE_ADHESION"]="adhesion";
Blockly.Msg["OBVE_VSTATE_RAININTENSITY"]="rain intensity";
Blockly.Msg["OBVE_STATE_CAMERAVIEWMODE"]="camera view mode";
Blockly.Msg["OBVE_STATE_DESTINATION"]="destination code";
Blockly.Msg["OBVE_LANGCODE"]="language code name";
Blockly.Msg["OBVE_GET_DOOR"]="%1 door(s) opening?";
Blockly.Msg["OBVE_DOOR_LEFT"]="left";
Blockly.Msg["OBVE_DOOR_RIGHT"]="right";
Blockly.Msg["OBVE_DOOR_BOTH"]="both";
Blockly.Msg["OBVE_DOOR_ANY"]="any";
Blockly.Msg["OBVE_SET_DOOR_INTERLOCK"]="%2 %1 door interlock";
Blockly.Msg["OBVE_DOORIXL_LOCK"]="lock";
Blockly.Msg["OBVE_DOORIXL_UNLOCK"]="unlock";
Blockly.Msg["OBVE_SOUND_PLAY"]="play sound #%1 volume%%:%2 pitch%%:%3 looping?:%4";
Blockly.Msg["OBVE_CAR_SOUND_PLAY"]="%1 sound #%2 volume%%:%3 pitch%%:%4 looping?:%5 car #:%6";
Blockly.Msg["OBVE_SOUND_BASIC"]="basic";
Blockly.Msg["OBVE_SOUND_CAR_INDEX"]="car";
Blockly.Msg["OBVE_SOUND_CAR_LIST"]="multiple";
Blockly.Msg["OBVE_SET_DEBUG_MESSAGE"]="set debug message to %1";
Blockly.Msg["OBVE_SHOW_MESSAGE"]="show message %1 color:%2 duration/s:%3";
Blockly.Msg["OBVE_COLOR_BLACK"]="black";
Blockly.Msg["OBVE_COLOR_GRAY"]="gray";
Blockly.Msg["OBVE_COLOR_WHITE"]="white";
Blockly.Msg["OBVE_COLOR_RED"]="red";
Blockly.Msg["OBVE_COLOR_ORANGE"]="orange";
Blockly.Msg["OBVE_COLOR_GREEN"]="green";
Blockly.Msg["OBVE_COLOR_BLUE"]="blue";
Blockly.Msg["OBVE_COLOR_MAGENTA"]="magenta";
Blockly.Msg["OBVE_DOOR_CHANGE_ANY"]="when any side door changed";
Blockly.Msg["OBVE_PERFORM_AI"]="when requested to perform ai action";
Blockly.Msg["OBVE_MSG_AI_WARN"]="Adding this block can remove a warning when entering the game.";
...
Blockly.Msg["BVE_MSG_ELAPSE_ONLY"]="Only use when 'elapse':";
Blockly.Msg["BVE_MSG_INIT_ONLY"]="Only use when 'init':";
Blockly.Msg["BVE_MSG_KEY_ANY_ONLY"]="Only use when 'key up/down':";
